    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          <h2>About Us</h2>
          <p style={{textAlign:'justify'}}>Team Blaze Suites booking partner providing the best experience.</p>
        </div>
        <div className="footer-section">
          <h2>Quick Links</h2>
          <ul>
            <li><a href="/" style={{textDecoration:'none',color:'white'}}>Home</a></li>
            <li><a href="/acc" style={{textDecoration:'none',color:'white'}}>Rooms</a></li>
      ...
      <div className="footer-bottom">
        <p>&copy; 2024 Team Blaze Suites. All rights reserved.</p>
      </div>
    </footer>
  );
};
